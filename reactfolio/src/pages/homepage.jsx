          ...
          <div className="homepage-container">
              ...
              <div className="homepage-first-area-right-side">
                <div className="homepage-image-container">
                  <div className="homepage-image-wrapper">
                    <img src="profile.jpg" alt="about" className="homepage-image" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="homepage-socials">
              ...
              <a href={INFO.socials.medium} target="_blank" rel="noreferrer">
                <FontAwesomeIcon icon={faMedium} className="homepage-social-icon" />
              </a>
            ...
            <div className="homepage-skills-section">
              <h2>My Skills & Expertise</h2>
              <p>
                As a Senior Full Stack Developer, I have hands-on experience in a wide range of
                technologies and tools. Explore my detailed skills and expertise to see how I can
